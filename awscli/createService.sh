...
then
	...
	aws application-autoscaling register-scalable-target --resource-id service/bwce-cluster/ShoppingCart --service-namespace ecs --scalable-dimension ecs:service:DesiredCount --min-capacity 1 --max-capacity 20 --role-arn arn:aws:iam::048063763713:role/aws-service-role/autoscaling.amazonaws.com/AWSServiceRoleForAutoScaling
